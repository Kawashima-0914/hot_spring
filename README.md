# はじめに
サイトへのアクセスは以下のリンクよりご覧ください。

https://kawashima-0914.github.io/hot_spring/


# 説明
当初は、djangoを用いて、開発していましたが、gitで上げるために、静的webページに変更しました。
...
# その他
その他には、静的webページに合わせる前のプロジェクトが入っています。

開発したのは、2022年ごろで、プログラミング経験もかなり浅い時期なので、寛大な目で見ていただけると幸いです。
